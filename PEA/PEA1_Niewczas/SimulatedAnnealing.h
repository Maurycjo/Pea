...
public:						
	void setStrartParametrs(int ver, int **matrix);	//ustawienie domyslnej temperatury i epoki
	//setery getery
	void setL(int l);
	void setT(int t);
	...
	void displayParametrs();						//wyswietlanie aktualnej temperatury epoki oraz alphy
